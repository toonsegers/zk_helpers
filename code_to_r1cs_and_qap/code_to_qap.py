import pynocchio.bn256 as bn256
import pynocchio.code_to_r1cs as c2r
import pynocchio.qap_creator as qc
import pprint
...
# Helper method from pysnark.runtime (Meilof Veeningen)
...
"""
    ...
    input_vars = [gf(3)]
    qap = QAP()
    qap.code_to_qap(code)
    # qap = code_to_qap(code)
    x = calculate_witness(code, input_vars)
    pp.pprint(qap.v)
    pp.pprint(x)
